...
public final class FragmentWelcome2Binding implements ViewBinding {
  ...
  private FragmentWelcome2Binding(@NonNull RelativeLayout rootView,
      @NonNull ImageView backgroundImage, @NonNull MaterialButton getStartedButton,
  ...
  @NonNull
  public static FragmentWelcome2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentWelcome2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_welcome2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentWelcome2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentWelcome2Binding((RelativeLayout) rootView, backgroundImage,
          getStartedButton, logoImage, skipIntroText, subtitleText, titleText);
    }
